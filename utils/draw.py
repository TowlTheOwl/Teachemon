...
def draw_binder(screen, left, right, binder, font, card_images, cards_owned, card_back, button_exit, card_zoom, binder_highlight, highlight_num, data):
    ...
    if card_zoom > 1 and card_num in cards_owned:
        ...
        if card_zoom >= 3:
            move1 = data[card_num]["Move 1 Name"]
            dmg1 = data[card_num]["Move 1 Damage"] + " DMG"
            screen.blit(font.render(move1.upper(), True, "Black"), (395, 315))
            screen.blit(font.render(dmg1.upper(), True, "Black"), (545, 330))

            move2 = data[card_num]["Move 2 Name"]
            dmg2 = data[card_num]["Move 2 Damage"] + " DMG"
            screen.blit(font.render(move2.upper(), True, "Black"), (395, 365))
            screen.blit(font.render(dmg2.upper(), True, "Black"), (545, 380))


            move3 = data[card_num]["Move 3 Name"]
            dmg3 = data[card_num]["Move 3 Damage"] + " DMG"
            screen.blit(font.render(move3.upper(), True, "Black"), (395, 415))
            screen.blit(font.render(dmg3.upper(), True, "Black"), (545, 430))
...
def draw_choose_your_team(screen:pygame.Surface, button_exit, text_cyt, cyt_rect, button_go_text, button_go_bg, button_go_rect, selected_cards, font_small, card_images, data):
    screen.fill("grey")
    pygame.draw.rect(screen, (150, 150, 150), button_go_bg, border_radius=5)
    screen.blit(button_go_text, button_go_rect)
    screen.blit(button_exit, (785,555))
    ...
    for i in range(4):
        card_image = pygame.transform.scale(card_images[selected_cards[i]], (145, 190))
        screen.blit(card_image, (160+i*180, 85))
        screen.blit(font_small.render(data[selected_cards[i]]["Move 1 Name"].upper(), True, "Black"), (177+180*i, 188))
        screen.blit(font_small.render(data[selected_cards[i]]["Move 1 Damage"] + " DMG".upper(), True, "Black"), (250+180*i, 197))
        screen.blit(font_small.render(data[selected_cards[i]]["Move 2 Name"].upper(), True, "Black"), (177+180*i, 213))
        screen.blit(font_small.render(data[selected_cards[i]]["Move 2 Damage"] + " DMG".upper(), True, "Black"), (250+180*i, 224))
...
def draw_card_wheel(screen, cards, selected_cards, pointer, font:pygame.font.Font, font_small, card_images, data):
    ...
    screen.blit(pygame.transform.scale(card_images[card], (145, 190)), (430, 305))
    
    screen.blit(font_small.render(data[card]["Move 1 Name"].upper(), True, "Black"), (447, 408))
    screen.blit(font_small.render(data[card]["Move 1 Damage"] + " DMG".upper(), True, "Black"), (520, 417))
    screen.blit(font_small.render(data[card]["Move 2 Name"].upper(), True, "Black"), (447, 433))
    screen.blit(font_small.render(data[card]["Move 2 Damage"] + " DMG".upper(), True, "Black"), (520, 442))
    screen.blit(font_small.render(data[card]["Move 3 Name"].upper(), True, "Black"), (447, 458))
    screen.blit(font_small.render(data[card]["Move 3 Damage"] + " DMG".upper(), True, "Black"), (520, 467))
    ...
    for i in range(2):
        ...
        if card is not None:
            ...
            if card in selected_cards:
                color = (255, 100, 100)
            card_image = pygame.transform.scale(card_images[card], (145, 190))
            screen.blit(card_image, (80+(i*175), y))
            screen.blit(font_small.render(data[card]["Move 1 Name"].upper(), True, "Black"), (98+175*i, 438))
            screen.blit(font_small.render(data[card]["Move 1 Damage"] + " DMG".upper(), True, "Black"), (170+175*i, 447))
            screen.blit(font_small.render(data[card]["Move 2 Name"].upper(), True, "Black"), (98+175*i, 463))
            screen.blit(font_small.render(data[card]["Move 2 Damage"] + " DMG".upper(), True, "Black"), (170+175*i, 472))
            screen.blit(font_small.render(data[card]["Move 3 Name"].upper(), True, "Black"), (98+175*i, 488))
            screen.blit(font_small.render(data[card]["Move 3 Damage"] + " DMG".upper(), True, "Black"), (170+175*i, 497))
    # draw right cards
    for i in range(2):
        card = cards_to_draw[i+3]
        if card is not None:
            ...
            card_image = pygame.transform.scale(card_images[card], (145, 190))
            screen.blit(card_image, (600+(i*175), y))
            screen.blit(font_small.render(data[card]["Move 1 Name"].upper(), True, "Black"), (618+175*i, 438))
            screen.blit(font_small.render(data[card]["Move 1 Damage"] + " DMG".upper(), True, "Black"), (690+175*i, 447))
            screen.blit(font_small.render(data[card]["Move 2 Name"].upper(), True, "Black"), (618+175*i, 463))
            screen.blit(font_small.render(data[card]["Move 2 Damage"] + " DMG".upper(), True, "Black"), (690+175*i, 472))
            screen.blit(font_small.render(data[card]["Move 3 Name"].upper(), True, "Black"), (618+175*i, 488))
            screen.blit(font_small.render(data[card]["Move 3 Damage"] + " DMG".upper(), True, "Black"), (690+175*i, 497))
